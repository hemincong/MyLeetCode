...
int main(int argc, char** argv) {
    Solution s;
    vector<vector<int>>connections_1{{0,1},{0,2},{1,2}};
    int n_1 = 4;
    int ret_1 = 1;
    EXPECT_EQ(s.makeConnected(n_1, connections_1), ret_1);

    vector<vector<int>> connections_2{{0,1},{0,2},{0,3},{1,2},{1,3}};
    int n_2 = 6;
    int ret_2 = 2;
    EXPECT_EQ(s.makeConnected(n_2, connections_2), ret_2);

    vector<vector<int>>connections_3{{0,1},{0,2},{0,3},{1,2}};
    int n_3 = 6;
    int ret_3 = -1;
    EXPECT_EQ(s.makeConnected(n_3, connections_3), ret_3);

    vector<vector<int>>connections_4{{0,1},{0,2},{3,4},{2,3}};
    int n_4 = 5;
    int ret_4 = 0;
